...
public class MainActivity extends AppCompatActivity {
    ...
    private void arvuta(){
        ...
        if (esimeneKaart == teineKaart){
            ...
            pr11.setImageResource(R.drawable.kusimark);
            pr12.setImageResource(R.drawable.kusimark);
            pr13.setImageResource(R.drawable.kusimark);
            pr14.setImageResource(R.drawable.kusimark);
            pr21.setImageResource(R.drawable.kusimark);
            pr22.setImageResource(R.drawable.kusimark);
            pr23.setImageResource(R.drawable.kusimark);
            pr24.setImageResource(R.drawable.kusimark);
            pr31.setImageResource(R.drawable.kusimark);
            pr32.setImageResource(R.drawable.kusimark);
            pr33.setImageResource(R.drawable.kusimark);
            pr34.setImageResource(R.drawable.kusimark);
    ...
    private void frontOfKaardidRessurssid() {
        ...
        pilt103 = R.drawable.deer;
        pilt104 = R.drawable.bear;
        pilt105 = R.drawable.bird;
        pilt106 = R.drawable.pig;
        pilt201 = R.drawable.cat;
        pilt202 = R.drawable.dog;
        pilt203 = R.drawable.deer;
        pilt204 = R.drawable.bear;
        pilt205 = R.drawable.bird;
        pilt206 = R.drawable.pig;
    }
}
